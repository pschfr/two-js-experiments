...
From there, I was able to make a decent variety of generative designs. Since Two automatically generated these as SVGs, they can be animated or made interactive with JavaScript (made simple with Two's built-in animation loop). The six smaller patterns directly below this paragraph don't have an associated .js file, but the 4 "special" patterns link to their respective .js files (just in case anyone is interested). Feel free to use and take whatever you want from this.<br><br>
